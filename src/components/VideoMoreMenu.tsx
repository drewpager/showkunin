  ...
  return (
    <>
      ...
      <Menu as="div" className="relative mr-2 inline-block text-left">
        <div>
          <MenuButton className="inline-flex h-full w-full justify-center rounded-full px-2 py-2 text-[#292D34] focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
                ...
                <DialogPanel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  >
                    <div className="sm:col-span-4">
                      <label
                        htmlFor="title"
                        className="block text-sm font-medium leading-6 text-custom-black"
                      >
                        Video title
                      </label>
                      <div className="mt-2">
                        <input
                          ...
                          type="title"
                          autoComplete="title"
                          className="block w-full rounded-md border-0 px-2 py-1.5 text-custom-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-custom-black sm:text-sm sm:leading-6"
                        />
                      </div>
                    </div>
                    ...
                    <button
                      type="submit"
                      className="mt-2 rounded-md bg-custom-black px-4 py-1.5 text-sm font-semibold text-white shadow-sm hover:bg-custom-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-custom-black"
                    >
                      Save
                    </button>
                  </form>
        ...
        >
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <DialogPanel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  <h3 className="text-lg font-bold leading-6 text-custom-black">
                    Are you sure?
                  </h3>
                  <div className="mt-2 text-sm text-gray-500">
                    Deletion is permanent. Once deleted, you will not be able to recover this video.
                  </div>
